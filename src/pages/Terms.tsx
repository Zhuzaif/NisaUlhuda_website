      ...
      <section className="relative bg-[#111827] min-h-[70vh] flex flex-col">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Historic Islamic Mosque Architecture Interior - Terms and Conditions" 
            fetchPriority="high"
            decoding="async"
        ...
        <div className="bg-white rounded-[2rem] shadow-2xl p-10 md:p-16 min-h-[500px]">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <div className="mb-12">
              ...
              <p className="leading-relaxed">
                If you have any questions about these Terms, please contact us at: <a href="mailto:nisa@hudalabs.app" className="font-medium text-[#D4AF37] hover:text-[#b3922d] transition-colors">nisa@hudalabs.app</a>
              </p>
            </div>
