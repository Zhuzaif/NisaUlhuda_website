          ...
          <div className="flex justify-between items-center border-b border-white/20 pb-4">
            ...
            <Link to="/" className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full border-2 border-[#c59d5f] flex items-center justify-center bg-white shadow-xl overflow-hidden">
                <img src={`${import.meta.env.BASE_URL}logo.webp`} alt="Nisa Ul Huda - Islamic Mobile Companion Logo" width="48" height="48" decoding="async" className="w-full h-full object-contain p-0.5" />
              </div>
